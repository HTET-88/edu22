...
<div class=" ">
	<div class="container pk text-center my-5">
		<h1 class=" wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Change Password here !!!</h1>
	</div>
</div>


<div class="privacy my-3">
	<div class="container en py-5">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Take the procedure!</h3>
		<form name="chngpwd" method="post" onSubmit="return valid();" class="wow ZoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
