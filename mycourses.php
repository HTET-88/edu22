...
<div class=" ">
	<div class="container text-center my-5 pk">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Your Courses, Check Here!</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
